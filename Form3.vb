Public Class Form3
    ...
    Private Sub cbo16_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbo16.SelectedIndexChanged
    ...
    Private Sub cbo8_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbo8.SelectedIndexChanged
